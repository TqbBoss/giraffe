...
public class PropertiesLoader {
    ...
    /**
     * Create a new {@link giraffe.cloud.framework.config.utf8.PropertiesLoader} instance.
     * @param resource the resource of the {@code .properties} data
     */
    PropertiesLoader(Resource resource) {
    ...
    Map<String, OriginTrackedValue> load(boolean expandLists) throws IOException {
        try (CharacterReader reader = new PropertiesLoader.CharacterReader(this.resource)) {
